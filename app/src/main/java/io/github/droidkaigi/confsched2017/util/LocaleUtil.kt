...
object LocaleUtil {
    ...
    fun setLocale(context: Context, languageId: String) {
        ...
        DefaultPrefs.languageId = languageId
    ...
    fun getCurrentLanguageId(): String {
        ...
        var languageId = DefaultPrefs.languageId
    ...
    fun getCurrentLanguage(context: Context): String = context.getString(getLanguage(LocaleUtil.getCurrentLanguageId()))
    ...
    fun getDisplayDate(date: Date): Date {
    ...
    fun getDisplayTimeZone(): TimeZone {
        val defaultTimeZone = TimeZone.getDefault()
        val shouldShowLocalTime = DefaultPrefs.showLocalTimeFlag
